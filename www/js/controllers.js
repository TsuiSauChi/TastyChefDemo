angular.module('app.controllers', ['firebase'])
  ...
  .controller('loginCtrl', ['$scope', '$stateParams', '$firebaseAuth', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
    // You can include any angular dependencies as parameters for this function
    // TIP: Access Route Parameters for your page via $stateParams.parameterName
    function ($scope, $stateParams, $firebaseAuth) {
      $scope.login = function () {
        console.log('test');
        var ref = new Firebase('https://facebook-TastyChefDemo.firebaseio.com');
        var authObject = $firebaseAuth(ref);

        authObject.$authWithAuthPopup('facebook').then(function (authData) {
